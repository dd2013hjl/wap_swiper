<template>
  <div id="wrap">
    <img src="http://www.pailixiang.com/Themes/album/images/close2.png" class="close_btn" />
    <div class="swiper-container" @click="toggleInfo">
      <div class="swiper-wrapper">
      </div>
    </div>

    <div class="footer" v-show="toggleInfoFlag">
  ...
  methods: {
    ...
    initSwiper (index, list) {
      const imgSwiper = new Swiper('.swiper-container', {
        ...
        virtual: {
          renderSlide: (item, index) => {
            var tpl = `<div class="swiper-slide"><img src='${
              item.src
            }' style="${this.imgStyle}"/></div>`
            return tpl
          },
          slides: list
        },
    ...
    toggleInfo () {
      this.toggleInfoFlag = !this.toggleInfoFlag
    }
  }
}
</script>
...
.thumbs-container .swiper-wrapper .thumb_active {
